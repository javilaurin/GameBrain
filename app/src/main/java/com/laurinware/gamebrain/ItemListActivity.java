...
import com.laurinware.gamebrain.dummy.DummyContent;
...
public class ItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String title = intent.getStringExtra(MainActivity.LIST_TYPE);

        // Initialize game list and get repo instance
